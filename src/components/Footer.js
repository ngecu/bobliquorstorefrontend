    ...
    <>
      ...
      <Col>
        <div id="custom_html-10" className="widget_text widget widget_custom_html">
          <span className="gamma widget-title">Over 1300 drinks available</span>
          <div className="textwidget custom-html-widget">
            <p>Oaks &amp; Corks has a wide selection of wines, gins, vodkas, rums, tequila, liqueurs, and other drinks to choose from.</p>
      ...
      <footer className="text-center text-lg-start  text-muted text-light">
